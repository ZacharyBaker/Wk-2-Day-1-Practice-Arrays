...
//Write a function named evenFinder that is given nums as it's 
...
//Above you're given a function that will return a random
// number between 0 and 30, and an array full of numbers. Your 
//job is to write a function named finder that will get a random 
//number, then loop through the array to see if that random number
...
//Write a function called addTen that is given 'numbers'
// as it's only argument and returns a new
...
//Write a function that is given arr1 and arr2 as
// it's only arguments. Return the array which is longest.

  //Code Here
var myFunction = function(arr1, arr2){
...
var user2 = {
    ...
    password: 'iLoveJavaPizza',
    username: 'dkafeifdkf'
};
var user3 = {
    name: 'tom hat',
    email: 'tman@gmail.com',
    password: 'iLovedoingstuff',
    username: 'pizzaman'
};
...
for (var obj in users){
  if (users[obj].email === "tylermcginnis33@gmail.com"){
    delete users[obj];
  }
}
//-----------------
